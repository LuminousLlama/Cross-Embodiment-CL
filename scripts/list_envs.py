...
importlib.import_module("Cross_Embodiment_CL.tasks")
...
def main() -> None:
    ...
    parser.add_argument("--keyword", default="CrossEmbodimentCl-", help="Substring used to filter task ids.")
    ...
    table.title = "Available Cross_Embodiment_CL Environments"
