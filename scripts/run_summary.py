...
DEFAULT_TAGS = [
    ...
    "Metrics/success", "Metrics/max_object_height",
    "Metrics/min_hand_distance", "Metrics/min_keypoint_error", "Metrics/final_keypoint_error",
    "Metrics/reach_return", "Metrics/goal_return", "Metrics/contact_return",
    "Metrics/contact_gate_fraction",
    "Contact/step_any_touch_fraction", "Contact/step_max_force", "Contact/step_thumb_force",
    "Contact/step_bodies_over_threshold",
    "Metrics/step_nearest_hand_distance",
    "Policy/mean_std", "Loss/entropy", "Loss/value", "Loss/learning_rate",
    "Control/step_action_saturation_fraction",
    "Terminations/timeout", "Terminations/workspace_exit", "Terminations/below_table",
    "Perf/total_fps",
]
SHORT = {"Metrics/": "M/", "Train/": "T/", "Control/": "C/", "Terminations/": "X/",
         "Policy/": "P/", "Loss/": "L/", "Perf/": "", "Contact/": "K/"}
        ...
        for row in csv.DictReader(stream):
            if row["tag"] in tags:
                ...
                if math.isfinite(value):
                    out[row["tag"]][int(row["step"])] = value
    return out
