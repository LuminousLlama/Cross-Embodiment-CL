...
if TYPE_CHECKING:
    from .env_cfg import BalanceMarlEnvCfg


class BalanceMarlEnv(DirectMARLEnv):
    """Cooperative cart-double-pendulum environment generated for a downstream project."""

    cfg: BalanceMarlEnvCfg

    def __init__(self, cfg: BalanceMarlEnvCfg, render_mode: str | None = None, **kwargs):
