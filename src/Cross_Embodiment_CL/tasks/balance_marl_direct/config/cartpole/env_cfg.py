...
@configclass
class BalanceMarlPhysicsCfg(PresetCfg):
    """Physics presets for the generated multi-agent environment."""
...
@configclass
class BalanceMarlEnvCfg(DirectMARLEnvCfg):
    """Configuration for the generated multi-agent environment."""
    ...
    # simulation
    sim: SimulationCfg = SimulationCfg(dt=1 / 120, render_interval=decimation, physics=BalanceMarlPhysicsCfg())
    ...
    success_upright_angle = math.pi / 12  # [rad]
    success_duration_s = 1.0  # [s]
