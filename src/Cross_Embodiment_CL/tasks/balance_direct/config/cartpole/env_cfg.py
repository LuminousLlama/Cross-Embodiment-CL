...
@configclass
class BalancePhysicsCfg(PresetCfg):
...
class BalanceEnvCfg(DirectRLEnvCfg):
    ...
    amp_observation_space = 4

    # simulation
    sim: SimulationCfg = SimulationCfg(dt=1 / 120, render_interval=decimation, physics=BalancePhysicsCfg())
    ...
    def __post_init__(self) -> None:
        """Configure the default visualizer camera."""
