...
if TYPE_CHECKING:
    from .env_cfg import BalanceEnvCfg


class BalanceEnv(DirectRLEnv):
    """Cart-pole balancing environment generated for a downstream project."""

    cfg: BalanceEnvCfg

    def __init__(self, cfg: BalanceEnvCfg, render_mode: str | None = None, **kwargs):
    ...
    def collect_reference_motions(self, num_samples: int, current_times: np.ndarray | None = None) -> torch.Tensor:
        # note: This is a placeholder for the reference motions. It should be implemented for the specific task.
