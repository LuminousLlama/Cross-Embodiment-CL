...
`right_finger5_joint4` order. The existing 141-D `student` group remains unchanged until a new student
architecture explicitly consumes force. Code that needs the diagnostic packet can call
